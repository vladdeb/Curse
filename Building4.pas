...
initialization
  ...
  AddAud(BSUIR[3][1], TAuditory.Create( 383, 389, 109, 'á', 4));
  ...
  AddAud(BSUIR[3][3], TAuditory.Create( 164, 391, 304, 'à', 4));
  ...
  AddAud(BSUIR[3][3], TAuditory.Create( 913, 391, 317, 'à', 4));
  ...
  AddAud(BSUIR[3][5], TAuditory.Create(  94, 315, 502, 'à', 4));
  AddAud(BSUIR[3][5], TAuditory.Create( 184, 315, 503, ' ', 4));
  AddAud(BSUIR[3][5], TAuditory.Create( 299, 315, 503, 'à', 4));
  AddAud(BSUIR[3][5], TAuditory.Create( 191, 315, 504, ' ', 4));
  AddAud(BSUIR[3][5], TAuditory.Create( 191, 315, 504, 'à', 4));
    ...
    begin
      ...
      begin
        ...
        if ((distx <= 30) or (disty <= 30)) and (distx <= 300) and not ((j = 20) and ((k = 22) or (k = 21)))
            and not ((j = 12) and (k = 24) or ( k = 23)) and
            not ((Length(BSUIR[3][i][k].Suf) = 8) and (BSUIR[3][i][k].Suf[1] = 'L') and (BSUIR[3][i][k].Suf[8] = '2') and (BSUIR[3][i][j].Suf[1] <> 'L')) then
        begin
