...
initialization
  ...
  AddAud(BSUIR[4][1], TAuditory.Create( 265, 408, 199, 'Ladderl2', 5));
  ...
  AddAud(BSUIR[4][2], TAuditory.Create( 440, 230, 299, 'Corridor', 5));
  ...
  AddAud(BSUIR[4][4], TAuditory.Create( 316, 475, 499, 'Ladderl2', 5));
  ...
  begin
    ...
    AddEdge(BSUIR[4], BSUIRGraph[4], 118, 224);
  AddEdge(BSUIR[4], BSUIRGraph[4], 118, 322);
  AddEdge(BSUIR[4], BSUIRGraph[4], 118, 419);
  AddEdge(BSUIR[4], BSUIRGraph[4], 118, 516);
  AddEdge(BSUIR[4], BSUIRGraph[4], 118, 615);
  AddEdge(BSUIR[4], BSUIRGraph[4], 118, 712);
  AddEdge(BSUIR[4], BSUIRGraph[4], 118, 812);
  AddEdge(BSUIR[4], BSUIRGraph[4], 118, 909);
  AddEdge(BSUIR[4], BSUIRGraph[4], 120, 226);
  AddEdge(BSUIR[4], BSUIRGraph[4], 120, 324);
  AddEdge(BSUIR[4], BSUIRGraph[4], 120, 421);
  AddEdge(BSUIR[4], BSUIRGraph[4], 120, 518);
  AddEdge(BSUIR[4], BSUIRGraph[4], 120, 617);
  AddEdge(BSUIR[4], BSUIRGraph[4], 120, 714);
  AddEdge(BSUIR[4], BSUIRGraph[4], 120, 814);
  AddEdge(BSUIR[4], BSUIRGraph[4], 120, 911);


  AddEdge(BSUIR[4], BSUIRGraph[4], 224, 322);
  AddEdge(BSUIR[4], BSUIRGraph[4], 224, 419);
  AddEdge(BSUIR[4], BSUIRGraph[4], 224, 516);
  AddEdge(BSUIR[4], BSUIRGraph[4], 224, 615);
  AddEdge(BSUIR[4], BSUIRGraph[4], 224, 712);
  AddEdge(BSUIR[4], BSUIRGraph[4], 224, 812);
  AddEdge(BSUIR[4], BSUIRGraph[4], 224, 909);
  AddEdge(BSUIR[4], BSUIRGraph[4], 226, 324);
  AddEdge(BSUIR[4], BSUIRGraph[4], 226, 421);
  AddEdge(BSUIR[4], BSUIRGraph[4], 226, 518);
  AddEdge(BSUIR[4], BSUIRGraph[4], 226, 617);
  AddEdge(BSUIR[4], BSUIRGraph[4], 226, 714);
  AddEdge(BSUIR[4], BSUIRGraph[4], 226, 814);
  AddEdge(BSUIR[4], BSUIRGraph[4], 226, 911);

  AddEdge(BSUIR[4], BSUIRGraph[4], 322, 419);
  AddEdge(BSUIR[4], BSUIRGraph[4], 322, 516);
  AddEdge(BSUIR[4], BSUIRGraph[4], 322, 615);
  AddEdge(BSUIR[4], BSUIRGraph[4], 322, 712);
  AddEdge(BSUIR[4], BSUIRGraph[4], 322, 812);
  AddEdge(BSUIR[4], BSUIRGraph[4], 322, 909);
  AddEdge(BSUIR[4], BSUIRGraph[4], 324, 421);
  AddEdge(BSUIR[4], BSUIRGraph[4], 324, 518);
  AddEdge(BSUIR[4], BSUIRGraph[4], 324, 617);
  AddEdge(BSUIR[4], BSUIRGraph[4], 324, 714);
  AddEdge(BSUIR[4], BSUIRGraph[4], 324, 814);
  AddEdge(BSUIR[4], BSUIRGraph[4], 324, 911);

  AddEdge(BSUIR[4], BSUIRGraph[4], 419, 516);
  AddEdge(BSUIR[4], BSUIRGraph[4], 419, 615);
  AddEdge(BSUIR[4], BSUIRGraph[4], 419, 712);
  AddEdge(BSUIR[4], BSUIRGraph[4], 419, 812);
  AddEdge(BSUIR[4], BSUIRGraph[4], 419, 909);
  AddEdge(BSUIR[4], BSUIRGraph[4], 421, 518);
  AddEdge(BSUIR[4], BSUIRGraph[4], 421, 617);
  AddEdge(BSUIR[4], BSUIRGraph[4], 421, 714);
  AddEdge(BSUIR[4], BSUIRGraph[4], 421, 814);
  AddEdge(BSUIR[4], BSUIRGraph[4], 421, 911);

  AddEdge(BSUIR[4], BSUIRGraph[4], 516, 615);
  AddEdge(BSUIR[4], BSUIRGraph[4], 516, 712);
  AddEdge(BSUIR[4], BSUIRGraph[4], 516, 812);
  AddEdge(BSUIR[4], BSUIRGraph[4], 516, 909);
  AddEdge(BSUIR[4], BSUIRGraph[4], 518, 617);
  AddEdge(BSUIR[4], BSUIRGraph[4], 518, 714);
  AddEdge(BSUIR[4], BSUIRGraph[4], 518, 814);
  AddEdge(BSUIR[4], BSUIRGraph[4], 518, 911);

  AddEdge(BSUIR[4], BSUIRGraph[4], 615, 712);
  AddEdge(BSUIR[4], BSUIRGraph[4], 615, 812);
  AddEdge(BSUIR[4], BSUIRGraph[4], 615, 909);
  AddEdge(BSUIR[4], BSUIRGraph[4], 617, 714);
  AddEdge(BSUIR[4], BSUIRGraph[4], 617, 814);
  AddEdge(BSUIR[4], BSUIRGraph[4], 617, 911);

  AddEdge(BSUIR[4], BSUIRGraph[4], 712, 812);
  AddEdge(BSUIR[4], BSUIRGraph[4], 712, 909);
  AddEdge(BSUIR[4], BSUIRGraph[4], 714, 814);
  AddEdge(BSUIR[4], BSUIRGraph[4], 714, 911);

  AddEdge(BSUIR[4], BSUIRGraph[4], 812, 909);
  AddEdge(BSUIR[4], BSUIRGraph[4], 814, 911);

  for i := 1 to 9 do
  begin
    for j := 0 to High(BSUIR[4][i]) do
    begin
      for k := j + 1 to High(BSUIR[4][i]) do
      begin
        distx := Abs(BSUIR[4][i][j].Pos.X - BSUIR[4][i][k].Pos.X);
        disty := Abs(BSUIR[4][i][j].Pos.Y - BSUIR[4][i][k].Pos.Y);
        if ((distx <= 10) or (disty <= 10)) and (distx <= 300)  then
        begin
          AddEdge(BSUIR[4], BSUIRGraph[4], i*100 + j, i*100 + k);
        end;
      end;
    end;
  end;
  AssignFile(graphFile, 'graph5.dat');
  rewrite(graphFile);
  for i := 1 to 1100 do
  begin
    Vertex.size := 0;
    for j := Low(BSUIRGraph[4][i]) to High(BSUIRGraph[4][i]) do
    begin
      Vertex.Vert[Vertex.size] := BSUIRGraph[4][i][j];
      Inc(Vertex.size);
    end;
